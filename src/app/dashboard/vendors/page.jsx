...
import { Search, Plus, Building2, CheckCircle, Mail, UserPlus } from "lucide-react";
...
export default function VendorsPage() {
  ...
  const handleViewProducts = (vendorId) => {
    // Navigate to inventory page with vendor filter
    window.location.href = `/dashboard/inventory?vendor=${vendorId}`;
  };
