...
export default function TeamPage() {
  ...
  // If user is public_vendor, override their plan to 'public_vendor' regardless of DB value
  let currentPlan = membershipInfo?.plan || "personal";
  if (isPublicVendor) {
    currentPlan = "public_vendor";
  }

  const limit = planLimits[currentPlan] || planLimits.personal;
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col p-4 lg:p-6">
          <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {teamMembers.length} /{" "}
                      {limit.members === Infinity ? "∞" : limit.members}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">
            ...
            {/* Upgrade Notice for Personal Plan - HIDDEN for Public Vendor */}
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      disabled={teamMembers.length >= limit.members}
                    >
                      ...
                      {[
                        {
                          key: "orders",
                          label: "Orders",
                          description: "View and manage eBay orders",
                        },
                        {
                          key: "inventory",
                          label: "Inventory",
                        ...
                        },
                        {
                          key: "accounts",
                          label: "Accounts",
                          description: "Manage eBay accounts",
                        },
                        {
                          key: "payments",
                          label: "Payments",
                        ...
                        >
                          ...
                          <div className="flex gap-2">
                            <Button
                              type="button"
                              variant={
                                inviteForm.permissions[module.key]?.includes(
                                  "view"
                                )
                                  ? "default"
                                  : "outline"
                              ...
                              onClick={() => {
                                const perms = [
                                  ...(inviteForm.permissions[module.key] || []),
                                ];
                          ...
                          >
                            ...
                            <div className="flex gap-2">
                              <Button
                                ...
                                onClick={() => {
                                  const perms = [
                                    ...(editingMember.permissions[module.key] ||
                                      []),
                                  ];
                                  if (perms.includes("view")) {
                                    // Remove view (and edit if exists)
      ...
      <Dialog open={isPricingOpen} onOpenChange={setIsPricingOpen}>
        <DialogContent className="max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-4 py-4">
            {/* Personal Plan */}
            <Card
              className={currentPlan === "personal" ? "border-primary" : ""}
            >
              <CardHeader>
            ...
            {/* Enterprise Plan */}
            <Card
              className={currentPlan === "enterprise" ? "border-primary" : ""}
            >
              <CardHeader>
              ...
              <CardContent>
                ...
                {currentPlan === "enterprise" ? (
                  ...
                  <Button
                    ...
                    onClick={() => {
                      toast.info(
                        "Please contact support to upgrade to Enterprise plan"
                      );
